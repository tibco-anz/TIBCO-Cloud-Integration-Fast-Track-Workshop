...
8.  The next two errors are relating to the **CreateMarketoLeadFlow** app created and exposed via Cloud Mesh earlier. You will need to bind the service to the activity to correct the errors.

<img src="/images/appimp/oz8.jpg" alt="appimp" width=700/>
