...
7. To correct the fetch customer details activity error, we must correct the db connection created earlier.  Browse and select the "crm db connection" you created earlier and hit save

<img src="/images/appimp/7_1.png" alt="appimp" width=500/>

8.  Observe the errors of the next two activities that needs to be corrected .  These two activities are connected to Auto-approve “Waive Shipment flow” residing in “LiveApps” section of TCI platform.
