...
In the next screen rename the app to **CreateMarketoLeadFlow**, click "Import app" and then "browse to upload"

<img src="/images/apisrvmshimp/oz4.png" alt="APISRVMSHIMP" width=800/>  

<img src="/images/apisrvmshimp/3.png" alt="APISRVMSHIMP" width=400/>

Select the file "createleadinMarketo.json" needed from your github downloaded project as shown below and click upload, followed by "Import all" in next dialog.
