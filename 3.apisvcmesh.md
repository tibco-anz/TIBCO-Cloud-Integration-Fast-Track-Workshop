...
Select the file "createleadinMarketo.json" needed from your github downloaded project as shown below and click upload, followed by "Upload" anad then "Import all" in next dialog.
